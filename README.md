# Caspian Fish Hub / Caspian Eco Monitor

MVP для хакатона: рыбак фиксирует улов, инспектор подтверждает уловы и экологические заявки, подтверждённые данные появляются на карте Каспия, рынок помогает продавать улов, а аналитика показывает нагрузку на море.
